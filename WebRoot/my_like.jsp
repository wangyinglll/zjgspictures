	...
	<div style="position:absolute;">
		...
		<div id="h_page">
			<div class="blank-middle">
				...
				<div style="height:16rem;text-align:center;padding:1rem">
					<img src="images/76094b36acaf2edd4509ec048f1001e938019367.jpg"
						class="img-centre" id="p_url" />
				</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-6 col-sm-6 blank-bottom right">
						<p id="b_like">
							<img src="icons/praise1.jpg" class="img-bottom" id="love" />喜欢
						</p>
		...
		<div id="h_page_two" style="display:none">
			<ul class="list-group">
				...
				<li><a href="#"><img
						src="images/231316p19paxp1p8q118qj.jpg"></a></li>
