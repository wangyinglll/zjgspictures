...
<link href="/pictures/css/bootstrap.min.css" rel="stylesheet"
	type="text/css" />
<script src="/pictures/js/jquery.touchslider.js" type="text/javascript"></script>
...
<body>
	...
	<div id="mySelect" style="display:none; background-color:#fff;">
		<p>
		...
		<div class="list-group">
			<a href="/pictures/picture/upload" class="list-group-item">
				...
				src="/pictures/icons/line.jpg" width="100%">
			</a> <a href="ranking_list.html" class="list-group-item">
				<h4 class="/pictures/picture/picturerank">照片排行</h4> <img
				src="/pictures/icons/line.jpg" width="100%">
			</a>
		</div>
	</div>
